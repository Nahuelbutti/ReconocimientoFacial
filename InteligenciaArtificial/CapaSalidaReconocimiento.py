...
import os
import imutils
dataRuta='D:/Documentos/Documentos/Proyectos Python/Recursos/reconocimientofacial1/data'
listaData=os.listdir(dataRuta)
entrenamientoEigenFaceRecognizer=cv.face.EigenFaceRecognizer_create()
entrenamientoEigenFaceRecognizer.read('D:/Documentos/Documentos/Proyectos Python/Recursos/EntrenamientoEigenFaceRecognizer.xml')
